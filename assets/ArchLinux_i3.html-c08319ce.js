import{_ as c,W as p,X as r,Y as n,Z as s,$ as a,a2 as o,a1 as t,C as l}from"./framework-68a75bb9.js";const d={},u={class:"hint-container details"},m=n("summary",null,"参考资料",-1),v={href:"https://archlinuxstudio.github.io/ArchLinuxTutorial/#/rookie/basic_install?id=arch-linux-%E5%9F%BA%E7%A1%80%E5%AE%89%E8%A3%85",target:"_blank",rel:"noopener noreferrer"},b={href:"https://www.expoli.tech/articles%2F2020%2F02%2F12%2F1581513647899",target:"_blank",rel:"noopener noreferrer"},k={href:"https://razonyang.com/zh-hans/archlinux-guide/xorg/",target:"_blank",rel:"noopener noreferrer"},h={href:"https://mindview.top/pages/be527f/",target:"_blank",rel:"noopener noreferrer"},g={href:"https://www.cnblogs.com/shadow-/p/17572589.html",target:"_blank",rel:"noopener noreferrer"},f={href:"https://blog.ccjp.top/index.php/archives/3/",target:"_blank",rel:"noopener noreferrer"},x={href:"https://github.com/fkxxyz/rime-cloverpinyin",target:"_blank",rel:"noopener noreferrer"},q={href:"https://blog.linioi.com/posts/clash-on-arch/",target:"_blank",rel:"noopener noreferrer"},y={href:"https://wiki.archlinuxcn.org/wiki/Mkinitcpio",target:"_blank",rel:"noopener noreferrer"},_={href:"https://zhuanlan.zhihu.com/p/571764449",target:"_blank",rel:"noopener noreferrer"},S={href:"https://juejin.cn/post/7317832600810160191",target:"_blank",rel:"noopener noreferrer"},w={href:"https://little-star.love/posts/f2114751/",target:"_blank",rel:"noopener noreferrer"},E={href:"https://www.linuxjiaocheng.com/2232.html",target:"_blank",rel:"noopener noreferrer"},A={href:"https://cloud.tencent.com/developer/article/1726016",target:"_blank",rel:"noopener noreferrer"},U={href:"https://hustlei.github.io/2018/11/msys2-pacman.html",target:"_blank",rel:"noopener noreferrer"},T={href:"https://www.cnblogs.com/devilmaycry812839668/p/17070158.html",target:"_blank",rel:"noopener noreferrer"},C={href:"https://blog.csdn.net/wys578/article/details/80984467",target:"_blank",rel:"noopener noreferrer"},L={href:"https://parrotsec-cn.org/t/linux-clash-dashboard/5169",target:"_blank",rel:"noopener noreferrer"},z=t(`<h2 id="梦前要备床" tabindex="-1"><a class="header-anchor" href="#梦前要备床" aria-hidden="true">#</a> 梦前要备床</h2><p>在今年1月初，正逢固态价格较低的时候，我用￥578.98的价格买下了 SOLIDIGM P44 PRO 海力士固态硬盘，并另外购置了一个高端硬盘盒 DOCKCASE Type-C 3.2, 该硬盘盒附带屏幕，还具备断电保护，实际测试大约有5s的断电保护。</p><div class="hint-container warning"><p class="hint-container-title">注意事项</p><p>含断电保护的硬盘盒一般在断电保护时会发生如下事情：</p><ol><li>检测到断电，此时电容放电，然后为当前硬盘写入读写保护标志</li><li>在电容放电时间内更新FTL映射表</li><li>更新完成后在不到10%的电量下进行弹出硬盘操作（移除读写保护标志等）</li><li>电容放电完毕，停止一切操作</li></ol><p>读写保护标志写入后，该盘会既无法读取，也无法写入任何数据，这意味着，当你关闭计算机时，PC断电后会立即触发硬盘盒断电保护的机制，如果在它未释放完所有电时启动计算机，此时硬盘仍处于读写保护状态，因此当计算机启动结束时用户会发现该盘无法读取/系统不识别该盘等类似问题。</p></div><h2 id="入梦的开始" tabindex="-1"><a class="header-anchor" href="#入梦的开始" aria-hidden="true">#</a> 入梦的开始</h2><p>提前准备好 ArchLinux 的镜像之后，通过 Ventoy 把 TF 卡做成启动盘，将镜像放入之后, 用户可在此时考虑直接给盘划好分区，不管怎么说，图形化分区还是比命令行分区更友好方便。在保证 Secure Boot 【安全启动】处于关闭, 且启动方式为 UEFI 的情况下, 通过 BIOS 启动【Portable PC一般按F12即可自行选择启动项】镜像系统。</p><blockquote><p>一般安装镜像系统是无图形化界面的，会以终端的形式出现。</p></blockquote><div class="hint-container info"><p class="hint-container-title">相关信息</p><p>【可选】执行<code>sudo systemctl stop reflector.service</code>来禁用 reflector ，以避免镜像源筛选不准确的可能性，该事件存在一定的概率会发生。</p><p>【可选】如已遗忘 BIOS 启动方式是否为 UEFI 时，可执行<code>ls /sys/firmware/efi/efivars</code>来查看，如若输出大量文字(EFI 变量)，说明当前已在 UEFI 模式。</p></div><h3 id="有线-无线联网" tabindex="-1"><a class="header-anchor" href="#有线-无线联网" aria-hidden="true">#</a> 有线/无线联网</h3><p>装机第一事，先连互联网。有线网络下插入网线即可【Portable PC可接入扩展坞后再接入网线】；无线网络下可使用 iwctl 接入，按照以下顺序依行键入命令：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>iwctl                           <span class="token comment"># 执行iwctl命令，进入交互式命令行</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>数据分区并不是系统运行必须，因此不必着急在此完成挂载，安装好系统后再做自动挂载也来得及。</p><h3 id="系统安装" tabindex="-1"><a class="header-anchor" href="#系统安装" aria-hidden="true">#</a> 系统安装</h3><p>接下来要安装系统了，在此之前先选择好镜像源，执行<code>vim /etc/pacman.d/mirrorlist</code>来查看当前所有镜像，并将中科大镜像源写到第一行中：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Server <span class="token operator">=</span> https://mirrors.ustc.edu.cn/archlinux/<span class="token variable">$repo</span>/os/<span class="token variable">$arch</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>一般进入 Zsh 后会自动进入配置环节，如果没进入的话需要手动执行<code>p10k configure</code>来进行主题配置，一般像前面装好字体之后就可以正常看到图标字符了。</p><p>配置好之后一般会自动帮你写好<code>.zshrc</code>文件，除去下面的alias，剩下的便是正常写好的样子：</p><details class="hint-container details"><summary>.zshrc 文件内容</summary><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># Enable Powerlevel10k instant prompt. Should stay close to the top of ~/.zshrc.</span>
...
fcitx5 <span class="token operator">&amp;</span>
  ...
  schema_list:
    - schema: clover
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,96),M={href:"https://github.com/hosxy/Fcitx5-Material-Color",target:"_blank",rel:"noopener noreferrer"},I=t(`<p>一般手动安装主题都是安装以下命令安装的：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone <span class="token operator">&lt;</span>link.to.github.repo<span class="token operator">&gt;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></details><p>这次的配置文件较以前在 ArcoLinux 中多了按照上次使用的编译方式进行编译，并且可以修改是否在保存时编译的设置。</p><h3 id="使用-clash-premium-and-dashboard-科学上网" tabindex="-1"><a class="header-anchor" href="#使用-clash-premium-and-dashboard-科学上网" aria-hidden="true">#</a> 使用 Clash Premium and Dashboard 科学上网</h3><p>科学上网，就用Clash保驾护航，首先需要安装：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> pacman <span class="token parameter variable">-S</span> archlinuxcn/clash-premium-bin <span class="token comment"># 安装该软件的Premium版本才能使用Rules规则</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,33),O=n("code",null,"sudo systemctl restart clash@<YOUR_USERNAME>",-1),D=t('<h3 id="linux-查找软件安装目录" tabindex="-1"><a class="header-anchor" href="#linux-查找软件安装目录" aria-hidden="true">#</a> Linux 查找软件安装目录</h3><p>Linux 一般安装的软件位置会在以下几个目录中，如有需要届时可以自行查找：</p><ol><li><code>/usr/share</code></li><li><code>/usr/local</code></li><li><code>/opt</code></li></ol><p>如果已知可执行程序，也可直接使用<code>whereis</code>, <code>which</code>等查看位置</p><h2 id="醒不过来了" tabindex="-1"><a class="header-anchor" href="#醒不过来了" aria-hidden="true">#</a> 醒不过来了</h2>',5);function N(R,F){const e=l("ExternalLinkIcon"),i=l("RouterLink");return p(),r("div",null,[n("details",u,[m,n("ol",null,[n("li",null,[n("a",v,[s("Arch Linux 基础安装"),a(e)])]),n("li",null,[n("a",b,[s("Arch Linux 启用 archlinuxcn 源"),a(e)])]),n("li",null,[n("a",k,[s("Arch Linux 安装 Xorg"),a(e)])]),n("li",null,[n("a",h,[s("ArchLinux下i3wm安装和简单配置美化"),a(e)])]),n("li",null,[n("a",g,[s("Arch Linux install i3-wm"),a(e)])]),n("li",null,[n("a",f,[s("Archlinux 下 fcitx5-rime 的使用"),a(e)])]),n("li",null,[n("a",x,[s("fkxxyz/rime-cloverpinyin - GitHub"),a(e)])]),n("li",null,[n("a",q,[s("Arch Linux Clash 安装配置记录"),a(e)])]),n("li",null,[n("a",y,[s("mkinitcpio - Archwiki"),a(e)])]),n("li",null,[n("a",_,[s("ArchLinux安装教程"),a(e)])]),n("li",null,[n("a",S,[s("2024年最好用的12款 Linux Terminal Emulator (终端模拟器)"),a(e)])]),n("li",null,[n("a",w,[s("Linux 下使用 Clash 科学上网"),a(e)])]),n("li",null,[n("a",E,[s("Linux查看软件安装目录及位置4种方法（Linux）"),a(e)])]),n("li",null,[n("a",A,[s("linux查看软件的安装位置简单方法"),a(e)])]),n("li",null,[n("a",U,[s("pacman常用命令"),a(e)])]),n("li",null,[n("a",T,[s("nvme硬盘的断电保护是否有用，是噱头、智商税还是真的有需要？购买DOCKCASE智能M2固态硬盘盒10秒保护"),a(e)])]),n("li",null,[n("a",C,[s("0.0.0.0和127.0.0.1、127.0.1.1、localhost"),a(e)])]),n("li",null,[n("a",L,[s("linux下部署Clash+dashboard"),a(e)])])])]),z,n("p",null,[s("接着先推荐一个主题，是我个人比较喜欢使用的一个主题："),n("a",M,[s("https://github.com/hosxy/Fcitx5-Material-Color"),a(e)])]),I,n("p",null,[s("至此，执行"),O,s("后就可以正常科学上网了，另外，如需要进入 Dashboard 界面，应点击这里的链接："),a(i,{to:"/Linux/localhost:9090/ui/clash-dashboard-git/"},{default:o(()=>[s("localhost:9090/ui/clash-dashboard-git/")]),_:1}),s(", 如果你不确定 Dashboard 的具体名字，可点该链接查看："),a(i,{to:"/Linux/localhost:9090/ui/"},{default:o(()=>[s("localhost:9090/ui/")]),_:1}),s("。")]),D])}const B=c(d,[["render",N],["__file","ArchLinux_i3.html.vue"]]);export{B as default};
