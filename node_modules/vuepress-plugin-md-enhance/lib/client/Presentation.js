...
export default Vue.extend({
    ...
    mounted() {
        ...
        this.code = decodeURIComponent(this.$el.dataset.code || "");
        ...
        if (revealElement) {
            ...
            void Promise.all(promises).then(([revealJS, ...plugins]) => {
                ...
                void reveal
                    .initialize(Object.assign(Object.assign(Object.assign({ backgroundTransition: "slide", hash: this.$frontmatter.layout === "Slide", mouseWheel: this.$frontmatter.layout === "Slide", transition: "slide", slideNumber: true }, REVEAL_CONFIG), (this.$frontmatter.reveal || {})), { embedded: this.$frontmatter.layout !== "Slide" }))
                    .then(() => {
                    this.loading = false;
                });
