...
const CAMELCASE_MAP = new Map([['css', 'CSS'], ['javascript', 'JavaScript']]); // Do not change casing of nested options

const SKIP_CASING_OPTIONS = ['request-headers', 'requestHeaders', 'cookies']; // Converts kebab-cased and snake_cased strings to camelCase.
...
function normalize(object, options) {
  ...
  return (0, _utils.merge)([object, options === null || options === void 0 ? void 0 : options.overrides], (path, prev, next) => {
    let skip = false;
    path = path.map(k => {
